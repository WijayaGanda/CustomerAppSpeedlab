...
class WelcomePageView extends GetView<WelcomePageController> {
          ...
          children: [
              ...
              child: PageView(
                ...
                children: [
                  _buildPage(
                    ...
                    description:
                        "Solusi terbaik untuk perawatan motor Anda. Dapatkan pelayanan profesional dengan mudah dan cepat melalui aplikasi Speedlab.",
                  ),
                  _buildPage(
                    isCompactHeight: isCompactHeight,
                    ...
                    description:
                        "Kami menyediakan teknisi handal, suku cadang original, dan transparansi proses servis langsung dari genggaman Anda.",
                  ),
                  _buildPage(
                    isCompactHeight: isCompactHeight,
                    icon: Icons.speed,
                    ...
                    description:
                        "Bergabunglah sekarang! Nikmati kemudahan reservasi, pantau riwayat servis, dan dapatkan promo menarik.",
                  ),
                ],
              ),
            ),
            Padding(
              padding: EdgeInsets.symmetric(
                horizontal: 24.0,
                vertical: isCompactHeight ? 12.0 : 20.0,
              ),
              child: Column(
  ...
  Widget _buildPage({
    ...
    return Padding(
      padding: EdgeInsets.all(isCompactHeight ? 24.0 : 32.0),
      child: Column(
        mainAxisSize: MainAxisSize.min,
        mainAxisAlignment: MainAxisAlignment.center,
        children: [
